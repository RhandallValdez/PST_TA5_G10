...
public class BookListFragment extends Fragment {
    ...
    public static  void  addBooks(){
        ...
        items.add(new Book("https://quelibroleo.com/images/libros/libro-1507203927.jpg"," Kazuo Ishiguro","Faber and Faber"," Nunca me abandones","Hailsham es una mezcla de internado victoriano y de colegio para hijos de hippies de los años sesenta.","Romance/Drama"));
        ...
        items.add(new Book("https://quelibroleo.com/images/libros/libro_1362412134.jpg"," Herman Melville"," Alianza"," Moby Dick","La lucha del hombre contra la bestia, contra el mal y contra el destino: eso es lo que el capitán Ahab busca al perseguir a Moby Dick.","Aventura"));
